...
def getGallicaReferences(subject):
    sru_endpoint_highRes = "https://gallica.bnf.fr/SRU"
    params = {
        'version': '1.2',
        'operation': 'searchRetrieve',
        'query': f"""dc.type any fascicule and dc.language any fre or dc.language any frm or dc.language any fro and text={subject}""",
        'recordSchema': 'dc',
        'startRecord': 1,
        'maximumRecords': 20
    }
    ...
    if contains_forbidden_words(title, forbidden_words):
        ...
        return getGallicaReferences(subject)
    else:
